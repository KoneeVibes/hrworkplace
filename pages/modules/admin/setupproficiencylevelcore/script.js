...
const setupProficiencyLevelCoreModal = document.querySelector(".setup-proficiency-level-core-module-modal");
const setupProficiencyLevelCoreForm = document.querySelector(".module-modal-form");
const setupProficiencyLevelCoreConfirmationModal = document.querySelector(".setup-proficiency-level-core-confirmation-modal");
const setupProficiencyLevelCoreDetailModal = document.querySelector(".module-detail-modal");
const setupProficiencyLevelCoreDetailBox = document.querySelector(".module-modal-detail-box");
...
setupProficiencyLevelCoreTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!setupProficiencyLevelCoreModal.classList.contains("close-modal") && !setupProficiencyLevelCoreModal.contains(e.target)) {
        handleCloseSetupProficiencyLevelCoreModal();
    }
    if (!setupProficiencyLevelCoreDetailModal.classList.contains("close-modal") && !setupProficiencyLevelCoreDetailModal.contains(e.target)) {
