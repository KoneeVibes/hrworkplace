  ...
  rows.length > 0
    ...
    : `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his illness management, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenIllnessManagementModal(event)">
...
illnessManagementForm.innerHTML = `
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseIllnessManagementModal()">
                <span>Cancel</span>
            </button>
