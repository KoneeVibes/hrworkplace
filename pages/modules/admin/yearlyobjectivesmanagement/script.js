  ...
  rows.length > 0
    ...
    : `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his yearly objectives management, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenYearlyObjectivesManagementModal(event)">
...
yearlyObjectivesManagementForm.innerHTML = `
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseYearlyObjectivesManagementModal()">
                <span>Cancel</span>
            </button>
