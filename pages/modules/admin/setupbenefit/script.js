...
const setupBenefitConfirmationModal = document.querySelector(".setup-benefit-confirmation-modal");
const setupBenefitDetailModal = document.querySelector(".module-detail-modal");
const setupBenefitDetailBox = document.querySelector(".module-modal-detail-box");
...
setupBenefitTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!setupBenefitModal.classList.contains("close-modal") && !setupBenefitModal.contains(e.target)) {
        handleCloseSetupBenefitModal();
    }
    if (!setupBenefitDetailModal.classList.contains("close-modal") && !setupBenefitDetailModal.contains(e.target)) {
