...
const setupQualificationModal = document.querySelector(".setup-qualification-module-modal");
const setupQualificationForm = document.querySelector(".module-modal-form");
const setupQualificationConfirmationModal = document.querySelector(".setup-qualification-confirmation-modal");
const setupQualificationDetailModal = document.querySelector(".module-detail-modal");
const setupQualificationDetailBox = document.querySelector(".module-modal-detail-box");
...
setupQualificationTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!setupQualificationModal.classList.contains("close-modal") && !setupQualificationModal.contains(e.target)) {
        handleCloseSetupQualificationModal();
    }
    if (!setupQualificationDetailModal.classList.contains("close-modal") && !setupQualificationDetailModal.contains(e.target)) {
