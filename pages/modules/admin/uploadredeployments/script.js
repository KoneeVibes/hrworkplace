...
const uploadRedeploymentsModal = document.querySelector(".upload-redeployments-module-modal");
const uploadRedeploymentsForm = document.querySelector(".module-modal-form");
const uploadRedeploymentsConfirmationModal = document.querySelector(".upload-redeployments-confirmation-modal");
const uploadRedeploymentsDetailModal = document.querySelector(".module-detail-modal");
const uploadRedeploymentsDetailBox = document.querySelector(".module-modal-detail-box");
...
uploadRedeploymentsTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!uploadRedeploymentsModal.classList.contains("close-modal") && !uploadRedeploymentsModal.contains(e.target)) {
        handleCloseUploadRedeploymentsModal();
    }
    if (!uploadRedeploymentsDetailModal.classList.contains("close-modal") && !uploadRedeploymentsDetailModal.contains(e.target)) {
