...
payrollManagementTable.innerHTML = rows.length > 0 ? (
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his payroll management, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenPayrollManagementModal(event)">
...
payrollManagementForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleClosePayrollManagementModal()">
                <span>Cancel</span>
            </button>
