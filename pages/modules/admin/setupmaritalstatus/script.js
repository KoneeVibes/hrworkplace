...
const setupMaritalStatusModal = document.querySelector(".setup-marital-status-module-modal");
const setupMaritalStatusForm = document.querySelector(".module-modal-form");
const setupMaritalStatusConfirmationModal = document.querySelector(".setup-marital-status-confirmation-modal");
const setupMaritalStatusDetailModal = document.querySelector(".module-detail-modal");
const setupMaritalStatusDetailBox = document.querySelector(".module-modal-detail-box");
...
setupMaritalStatusTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!setupMaritalStatusModal.classList.contains("close-modal") && !setupMaritalStatusModal.contains(e.target)) {
        handleCloseSetupMaritalStatusModal();
    }
    if (!setupMaritalStatusDetailModal.classList.contains("close-modal") && !setupMaritalStatusDetailModal.contains(e.target)) {
