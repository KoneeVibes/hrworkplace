...
const setupProficiencyLevelModal = document.querySelector(".setup-proficiency-level-module-modal");
const setupProficiencyLevelForm = document.querySelector(".module-modal-form");
const setupProficiencyLevelConfirmationModal = document.querySelector(".setup-proficiency-level-confirmation-modal");
const setupProficiencyLevelDetailModal = document.querySelector(".module-detail-modal");
const setupProficiencyLevelDetailBox = document.querySelector(".module-modal-detail-box");
...
setupProficiencyLevelTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
window.addEventListener("click", (e) => {
    ...
    if (!setupProficiencyLevelModal.classList.contains("close-modal") && !setupProficiencyLevelModal.contains(e.target)) {
        handleCloseSetupProficiencyLevelModal();
    }
    if (!setupProficiencyLevelDetailModal.classList.contains("close-modal") && !setupProficiencyLevelDetailModal.contains(e.target)) {
