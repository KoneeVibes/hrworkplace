const confirmationTable = document.querySelector(".module-table");
...
confirmationTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
...
function handleOpenConfirmationConfirmatoryModal(e) {
    e.stopPropagation();
