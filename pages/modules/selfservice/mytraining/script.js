const trainingTable = document.querySelector(".module-table");
...
trainingTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his training, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenTrainingModal(event)">
...
trainingForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseTrainingModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseTrainingModal() {
    trainingModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
...
function handleOpenConfirmationModal(e) {
    ...
    trainingConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    trainingConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
