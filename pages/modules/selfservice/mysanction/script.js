const sanctionTable = document.querySelector(".module-table");
...
sanctionTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his sanction, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenSanctionModal(event)">
                <span>Add New Sanction</span>
            </button>
        </div>
    </div>`
);

sanctionForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseSanctionModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseSanctionModal() {
    sanctionModal.classList.add("close-modal");
...
function handleOpenConfirmationModal(e) {
    ...
    sanctionConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    sanctionConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
