const appraisal360Table = document.querySelector(".module-table");
...
appraisal360Table.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his 360 degree appraisal, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpen360DegreeAppraisalModal(event)">
                <span>Add New 360 Degree Appraisal</span>
            </button>
        </div>
    </div>`
);

appraisal360Form.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleClose360DegreeAppraisalModal()">
                <span>Cancel</span>
            </button>
...
function handleClose360DegreeAppraisalModal() {
    appraisal360Modal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
...
function handleOpenConfirmationModal(e) {
    ...
    appraisal360ConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    appraisal360ConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
