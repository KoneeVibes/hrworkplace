const leaveRequestTable = document.querySelector(".module-table");
...
leaveRequestTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his leave request, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenLeaveRequestModal(event)">
...
leaveRequestForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseLeaveRequestModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseLeaveRequestModal() {
    leaveRequestModal.classList.add("close-modal");
...
function handleOpenConfirmationModal(e) {
    ...
    leaveRequestConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    leaveRequestConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
