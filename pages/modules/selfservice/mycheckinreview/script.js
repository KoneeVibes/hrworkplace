const checkInReviewTable = document.querySelector(".module-table");
...
checkInReviewTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his check-in review, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenCheckInReviewModal(event)">
                <span>Add New Check-in Review</span>
            </button>
        </div>
    </div>`
);

checkInReviewForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseCheckInReviewModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseCheckInReviewModal() {
    checkInReviewModal.classList.add("close-modal");
...
function handleOpenConfirmationModal(e) {
    ...
    checkInReviewConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    checkInReviewConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
