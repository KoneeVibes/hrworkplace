const businessAcademyTable = document.querySelector(".module-table");
...
businessAcademyTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon logs his business academy, they will show up here</p>
        </div>
        <div class="cta-box">
            <button onclick="handleOpenBusinessAcademyModal(event)">
                <span>Add New Business Academy</span>
            </button>
        </div>
    </div>`
);

businessAcademyForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseBusinessAcademyModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseBusinessAcademyModal() {
    businessAcademyModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
...
function handleOpenConfirmationModal(e) {
    ...
    businessAcademyConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    businessAcademyConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
