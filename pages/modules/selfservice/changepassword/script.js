const changePasswordTable = document.querySelector(".module-table");
...
changePasswordTable.innerHTML = rows.length > 0 ? (
    `<table>
        <thead>
            <tr>
    ...
    `<div class="call-to-action">
        ...
        <div>
            ...
            <p>When Ofofon changes his password, they will show up here</p>
        </div>
        <div class="cta-box">
...
changePasswordForm.innerHTML = (`
    <form>
        ...
        <div class="row form-cta">
            <button type="reset" onclick="handleCloseChangePasswordModal()">
                <span>Cancel</span>
            </button>
...
function handleCloseChangePasswordModal() {
    changePasswordModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
...
function handleOpenConfirmationModal(e) {
    ...
    changePasswordConfirmationModal.classList.remove("close-modal");
    document.body.style.overflow = "hidden";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 0.1;
        item.style.pointerEvents = "none";
...
function handleCloseConfirmationModal() {
    changePasswordConfirmationModal.classList.add("close-modal");
    document.body.style.overflow = "auto";
    markedForDeHighlighting.forEach((item) => {
        item.style.opacity = 1;
        item.style.pointerEvents = "auto";
